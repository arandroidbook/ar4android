/* VuforiaNative - ProximityBasedJME Example
 *
 * Example Chapter 6
...
class ProximityBasedJME_UpdateCallback : public QCAR::UpdateCallback
{   
...
ProximityBasedJME_UpdateCallback updateCallback;


JNIEXPORT void JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_setActivityPortraitMode(JNIEnv *, jobject, jboolean isPortrait)
{
...
JNIEXPORT void JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_switchDatasetAsap(JNIEnv *, jobject)
{
...
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_initTracker(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_initTracker");
...
JNIEXPORT void JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_deinitTracker(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_deinitTracker");
...
JNIEXPORT int JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_loadTrackerData(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_loadTrackerData");
...
JNIEXPORT int JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_destroyTrackerData(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_destroyTrackerData");
...
JNIEXPORT void JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_onQCARInitializedNative(JNIEnv *, jobject)
{
...
JNIEXPORT void JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJME_updateTracking(JNIEnv *env, jobject obj)
{
    //LOG("Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_GLRenderer_renderFrame");
    ...
    for(int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
    {
        ...
        {
           // LOG("w %d %d",viewportWidth,screenWidth);
        ...
        {
           // LOG("h %d %d",viewportHeight,screenHeight);
...
JNIEXPORT void JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_initApplicationNative(
                            JNIEnv* env, jobject obj, jint width, jint height)
{
    LOG("Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_initApplicationNative");
    ...
    LOG("Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_initApplicationNative finished");
}


JNIEXPORT void JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_deinitApplicationNative(
                                                        JNIEnv* env, jobject obj)
{
    LOG("Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_deinitApplicationNative");
...
JNIEXPORT void JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_startCamera(JNIEnv *,
                                                                         jobject)
{
    LOG("Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_startCamera");
...
JNIEXPORT void JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_stopCamera(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_stopCamera");
...
JNIEXPORT void JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_setProjectionMatrix(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_setProjectionMatrix");
...
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_activateFlash(JNIEnv*, jobject, jboolean flash)
{
    return QCAR::CameraDevice::getInstance().setFlashTorchMode((flash==JNI_TRUE)) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_autofocus(JNIEnv*, jobject)
{
...
JNIEXPORT jboolean JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_setFocusMode(JNIEnv*, jobject, jint mode)
{
    int qcarFocusMode;
...
JNIEXPORT void JNICALL
Java_com_ar4android_proximityBasedJME_ProximityBasedJME_initTracking(
                        JNIEnv* env, jobject obj, jint width, jint height)
{
    LOG("Java_com_ar4android_proximityBasedJME_ProximityBasedJMEActivity_ProximityBasedJMERenderer_updateRendering");
