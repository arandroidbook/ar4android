/* ProximityBasedJMEActivity - ProximityBasedJME Example
 * 
 * Example Chapter 6
...
public class ProximityBasedJMEActivity extends AndroidHarness {

	private static final String TAG = "ProximityBasedJMEActivity";
    ...
    private class InitQCARTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            {
                QCAR.setInitParameters(ProximityBasedJMEActivity.this, mQCARFlags);
    ...
    public void updateRenderView()
    {
        ...
        if (currentScreenRotation != mLastScreenRotation)
        {
            ...
            {
                Log.d(TAG,"ProximityBasedJMEActivity::updateRenderView");
     ...
     * access by ProximityBasedJMEActivity::onResume() and InitQCARTask::onPostExecute(). */
	...
	public ProximityBasedJMEActivity() {
		// Set the application class to run
		appClass = "com.ar4android.proximityBasedJME.ProximityBasedJME";
	...
	public void initializeImageBuffer(int width,int height)
	{
	 ...
	 public void setRGB565CameraImage(byte[] buffer, int width, int height)  {
			...
			if ((com.ar4android.proximityBasedJME.ProximityBasedJME) app != null) {
				((com.ar4android.proximityBasedJME.ProximityBasedJME) app)
...
//        QCAR.onSurfaceCreated();
    ...
    {
       // DebugLog.LOGD("ProximityBasedJMEActivity::onConfigurationChanged");
